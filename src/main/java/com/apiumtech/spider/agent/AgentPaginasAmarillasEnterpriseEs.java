...
public class AgentPaginasAmarillasEnterpriseEs extends Agent
{
    ...
    public String completeUrl(String url, String link)
    {
        String r = link;
    ...
    public List<String> completeUrls(String url, List<String> links)
    {
    ...
    public List<String> unescapeUrls(List<String> urls)
    {
        List<String> r = new ArrayList<String>();
    ...
    public void parseURL(String url) throws IOException, InterruptedException {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
